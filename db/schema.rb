...
ActiveRecord::Schema.define(version: 20200302160452) do
  ...
  create_table "doctor_patients", force: :cascade do |t|
    ...
    t.index ["doctors_id"], name: "index_doctor_patients_on_doctors_id"
  ...
  add_foreign_key "doctor_patients", "doctors", column: "doctors_id"
